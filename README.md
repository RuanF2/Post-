...
- [x] `postController` + `postRoutes` (CRUD completo de posts, com verificação de autoria)
- [x] `commentController` (criar, listar por post, deletar — com verificação de autoria)
- [ ] Rotas de comentários (`commentRoutes`)
- [ ] Controllers: `likes`, `follows`
- [ ] Frontend
- [ ] Deploy
